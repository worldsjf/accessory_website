...
<link rel="stylesheet" href="<?php echo base_url('backend/css/morris.css'); ?>" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="<?php echo base_url('backend/css/monthly.css'); ?>">

<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="<?php echo base_url('backend/js/jquery2.0.3.min.js'); ?>"></script>
<script src="<?php echo base_url('backend/js/raphael-min.js'); ?>"></script>
<script src="<?php echo base_url('backend/js/morris.js'); ?>"></script>
